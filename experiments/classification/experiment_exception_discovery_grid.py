...
class Experiment:
    ...
    def _get_models(self):
        ...
        return {"algorithm_mincov_5_threshold_0_6": algorithm_mincov_5_threshold_0_6,
                "algorithm_mincov_5_threshold_0_7": algorithm_mincov_5_threshold_0_7,
                "algorithm_mincov_5_threshold_0_8": algorithm_mincov_5_threshold_0_8,
                "algorithm_mincov_5_threshold_0_9": algorithm_mincov_5_threshold_0_9,
                "algorithm_mincov_0_1_threshold_0_6": algorithm_mincov_0_1_threshold_0_6,
                "algorithm_mincov_0_1_threshold_0_7": algorithm_mincov_0_1_threshold_0_7,
                "algorithm_mincov_0_1_threshold_0_8": algorithm_mincov_0_1_threshold_0_8,
                "algorithm_mincov_0_1_threshold_0_9": algorithm_mincov_0_1_threshold_0_9}   
    ...
    def _evaluate_rules(self, ruleset, dataset, model_name, X, y):
    ...
    def _run_experiment(self,datasets_path:str, dataset_with_model: dict) -> pd.DataFrame:
        ...
        evauluation_df = self._evaluate_rules(model.ruleset, dataset, model_name, self.X, self.y)
...
if __name__ == "__main__":
    ...
    results_path = f"./results/exception_discovery_grid/"
